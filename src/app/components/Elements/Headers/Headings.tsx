...
export const Header2 = ({ children, className }: Props) => (
	<h2 className={clsx(['text-[1.8rem] lg:text-[2.486rem] font-bold text-white uppercase', className])}>
		{children}
	</h2>
);
...
export const Header6 = ({ children, className }: Props) => (
	<h6 className={clsx(['font-medium leading-tight text-[1.2rem] font-title', className])}>{children}</h6>
);